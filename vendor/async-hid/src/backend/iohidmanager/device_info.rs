...
use objc2_io_kit::{
    kIOHIDDeviceUsageKey, kIOHIDDeviceUsagePageKey, kIOHIDDeviceUsagePairsKey, kIOHIDManufacturerKey, kIOHIDPrimaryUsageKey,
    kIOHIDPrimaryUsagePageKey, kIOHIDProductIDKey, kIOHIDProductKey, kIOHIDSerialNumberKey, kIOHIDVendorIDKey, kIOReturnSuccess, IOHIDDevice,
