...
// IOHID interprets this value as milliseconds. The upstream 250 ms deadline
// expires before Bluetooth HID++ devices such as the MX Master 3 acknowledge
// valid writes, causing every later report response to miss its request.
const WRITE_REPORT_TIMEOUT_MS: f64 = 5_000.0;
